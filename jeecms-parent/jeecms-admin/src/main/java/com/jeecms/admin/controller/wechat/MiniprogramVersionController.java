...
public class MiniprogramVersionController extends BaseController<MiniprogramVersion, Integer> {
	...
	// TODO 此处有大问题，所有的东西都取决于模板有一个最新的，而如果没有一个最新的，那么下方的所有代码假设都不存在
	 ...
	 */
	@PostMapping("/audit")
	public ResponseInfo addAuditVersion(@RequestBody @Valid MiniprogramAuditDto dto, BindingResult result)
	 ...
	 */
	@DeleteMapping("/audit")
	public ResponseInfo deleteAudit(@RequestBody @Valid DeleteDto ids, BindingResult result)
			throws GlobalException {
		super.validateBindingResult(result);
	 ...
	 */
	@GetMapping("/qrcode")
	public ResponseInfo getQrcode(@RequestParam String appId) throws Exception {
