...
public class SysTemplateController extends AbstractTplAndResourceController {
    ...
    public ResponseInfo export(@RequestBody Map<String, String> map, HttpServletRequest request,
        ...
        try {
            ...
            Zipper.zip(response.getOutputStream(), fileEntrys, "UTF-8");
        } catch (IOException e) {
            log.error("export template error!", e);
            return new ResponseInfo(SysOtherErrorCodeEnum.EXPORT_TEMPLATE_ERROR.getCode(),
                    SysOtherErrorCodeEnum.EXPORT_TEMPLATE_ERROR.getDefaultMessage());
        }
        return null;
    }
