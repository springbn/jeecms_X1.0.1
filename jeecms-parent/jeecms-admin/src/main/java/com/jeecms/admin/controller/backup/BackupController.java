...
public class BackupController {
    ...
    @ResponseBody
    public ResponseInfo databaseRecovery(@PathVariable Integer backupId, HttpServletRequest request) throws GlobalException {
    ...
    @ResponseBody
    public ResponseInfo delete(@PathVariable Integer backupId) throws GlobalException {
