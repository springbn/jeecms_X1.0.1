...
public class CoreUserController extends BaseAdminController<CoreUser, Integer> {
	...
	@GetMapping("/page")
	@MoreSerializeField({
			@SerializeField(clazz = CoreUser.class, includes = { "id", "username", "enabled", "createTime",
	...
	public ResponseInfo pageUser(HttpServletRequest request, Boolean enabled, String key, Integer orgid, Integer roleid,
			Integer userSecretId, @PageableDefault(sort = "createTime", direction = Direction.DESC) Pageable pageable)
