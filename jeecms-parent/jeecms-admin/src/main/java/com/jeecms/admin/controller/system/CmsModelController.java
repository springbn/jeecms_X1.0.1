...
public class CmsModelController extends BaseController<CmsModel, Integer>{
	...
	@MoreSerializeField({	
	@SerializeField(clazz = CmsModel.class, includes = { "id", "modelName", "isGlobal", "isEnable", "tplType", "site","unEnableJson","enableJson"}),
	 ...
	 */
	@GetMapping("/page")
	@SerializeField(clazz = CmsModel.class, includes = { "id", "modelName", "siteId", "isEnable", "tplType","isGlobal"})
	public ResponseInfo page(HttpServletRequest request, HttpServletResponse response,
			Short isGlobal,Short tplType,Boolean isEnable,String modelName,Pageable pageable) throws GlobalException {
		return modelService.getModelPage(tplType,isGlobal,isEnable, modelName, SystemContextUtils.getSiteId(request), pageable);
	}
	...
	public ResponseInfo thisSite(HttpServletRequest request,@RequestBody @Valid CmsModel model, BindingResult result) throws GlobalException{
	 ...
	 */
	@PutMapping("/isEnable")
	public ResponseInfo isEnable(@RequestBody @Valid CmsModelDto modelDto, BindingResult result) throws GlobalException{
		super.validateBindingResult(result);
	...
	public ResponseInfo checkModelName(@NotNull String modelName,@NotNull  Short isGlobal,
			@NotNull  Short tplType, Integer id,HttpServletRequest request) throws GlobalException {
