...
public class ContentConstant {
        ...
        public static Map<String, String> order() {
                Map<String, String> a = ImmutableMap.of("0", "默认排序", "1", "创建时间降序", "2", "创建时间升序", "3", "总访问数降序", "4",
                                "总访问数升序");
                Map<String, String> b = ImmutableMap.of("5", "月访问数降序", "6", "月访问数升序", "7", "周访问数降序", "8", "周访问数升序");
                Map<String, String> c = ImmutableMap.of("9", "日访问数降序", "10", "日访问数升序", "11", "总评论数降序", "12", "总评论数升序");
                ...
                Map<String, String> map = new LinkedHashMap<String, String>(26);
                map.putAll(a);
                map.putAll(b);
                map.putAll(c);
                map.putAll(d);
        ...
        /** 内容状态(1:草稿; 2-初稿 3:流转中; 4:已审核; 5:已发布; 6:驳回; 7:下线 8-归档; 9:暂存;) **/
        ...
        public static List<Integer> getNotAllowRepeatStatus() {
                return Arrays.asList(STATUS_DRAFT, STATUS_FIRST_DRAFT, STATUS_FLOWABLE, STATUS_WAIT_PUBLISH,
                                STATUS_PUBLISH, STATUS_BACK, STATUS_NOSHOWING, STATUS_TEMPORARY_STORAGE);
        }
