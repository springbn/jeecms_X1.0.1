...
public interface ContentFrontService {
	 ...
	 * @return 详细投稿信息
	 */
	ContentContributeVo splicContributeVo(Content content);
	...
	* @throws GlobalException 异常
	 */
	Page<ContentMobileVo> getMobilePage(Integer siteId, Integer userId,
	 ...
	 * @throws GlobalException 异常
	 */
	ContentMobileVo initMobileVo(ContentMobileVo vo, Content content) throws GlobalException;
}
