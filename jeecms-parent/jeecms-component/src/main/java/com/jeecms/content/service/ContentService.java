...
public interface ContentService extends IBaseService<Content, Integer> {
	 ...
	 * @return: void
	 */
	Content save(ContentSaveDto dto, HttpServletRequest request) throws GlobalException;
	 ...
	 * @return: void
	 */
	void submit(ContentUpdateDto dto, HttpServletRequest request) throws GlobalException;
