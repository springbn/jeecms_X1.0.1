			...
			if (emails != null) {
				try {
					messageService.sendMemberMsg(null, null, null, null,
							null, null, MessageSceneEnum.USER_MESSAGE, MessageTempleEnum.LOG_WARN_TEMP.getTitle(),
	...
	private void sendSMS(String smsList, Integer dangerValue, Float size, String dangerSmsTmpId) {
		...
		if (dangerValue <= size) {
			...
			if (phones != null) {
				try {
					messageService.sendMemberMsg(null, null, null, null,
							null, dangerSmsTmpId, MessageSceneEnum.USER_MESSAGE, MessageTempleEnum.LOG_WARN_TEMP.getTitle(),
