...
import com.jeecms.system.domain.dto.OrgPermUnitDto;
import com.jeecms.system.domain.dto.OwnerSitePermDto;
import com.jeecms.system.domain.dto.OwnerSitePermUnitDto;
import com.jeecms.system.domain.dto.UserPermDto;
import com.jeecms.system.domain.dto.UserPermUnitDto;
import com.jeecms.system.domain.dto.CmsDatePermDto.ChannelRow;
import com.jeecms.system.domain.dto.CmsDatePermDto.ChannelUnit;
import com.jeecms.system.domain.dto.CmsDatePermDto.MenuMap;
import com.jeecms.system.domain.dto.CmsDatePermDto.MiniDataUnit;
import com.jeecms.system.domain.dto.CmsDatePermDto.SiteMap;
import com.jeecms.system.domain.dto.CmsDatePermDto.SiteRow;
...
public class CmsDataPermServiceImpl extends BaseServiceImpl<CmsDataPerm, CmsDataPermDao, Integer>
        ...
        public void updateByDto(CmsDatePermDto dto) throws GlobalException {
                ...
                if (dto.getOrgId() != null) {
                        ...
                        /** 从新分配权限，需要清空权限缓存 */
                        org.clearPermCache();
                        for (CoreUser u : org.getUsers()) {
                                u.clearPermCache();
                        }
                        for (CoreRole r : org.getRoles()) {
                                r.clearPermCache();
                        }
                } else if (dto.getRoleId() != null) {
                        /** 需要验证更新后的权限 */
