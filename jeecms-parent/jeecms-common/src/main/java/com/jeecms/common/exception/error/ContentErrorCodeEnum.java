...
public enum ContentErrorCodeEnum implements ExceptionInfo {
	...
	/**没有该栏目的内容修改权限*/
	NO_PERMISSION_MODIFY_ERROR("10502", "No permission to modify the channel content!"),
	/**没有该栏目的内容删除权限*/
	NO_PERMISSION_DEL_ERROR("10503", "No permission to delete the channel content!"),
	/**没有该栏目的内容发布权限*/
	NO_PERMISSION_PUBLISH_ERROR("10504", "No permission to publish the channel content!"),
	/**没有该栏目的内容微博推送权限*/
	NO_PERMISSION_WEIBO_PUSH_ERROR("10505", "No permission to weibo push the channel content!"),
	/**没有该栏目的内容创建权限*/
	NO_PERMISSION_CREATE_CONTENT_ERROR("10506", "No permission to create the channel content!"),
	/**没有该栏目的内容站点推送权限*/
	NO_PERMISSION_SITE_PUSH_ERROR("10507", "No permission to site push the channel content!"),
	/**没有该栏目的内容微信推送权限*/
	NO_PERMISSION_WECHAT_PUSH_ERROR("10507", "No permission to wechat push the channel content!"),
	/**没有该栏目的内容查看权限*/
	NO_PERMISSION_VIEW_ERROR("10508", "No permission to view the channel content!"),
	/**不可引用自身的栏目**/
	NO_QUOTE_CHANNEL_MYSELF_ERROR("10509", "Do not quote your own column!"),
	/** 该栏目已经存在该内容的引用**/
	ALREADY_QUOTE_CHANNEL_CONTENT("10510", "A column that cannot be referenced "
			+ "is a reference to a column that already exists!"),
	/** 站点或栏目内标题不允许重复*/
	...
	/** 导入格式不支持*/
	IMPORT_FORMAT_NOT_SUPPORTED("10539","Import format is not supported!"),
	/** 引用的内容无法推送*/
