...
public enum ChannelErrorCodeEnum implements ExceptionInfo {
	...
	/**没有该栏目修改权限*/
	NO_PERMISSION_MODIFY_CHANNEL_ERROR("11002", "No permission to modify the channel!"),
	/**没有该栏目删除权限*/
	NO_PERMISSION_DEL_CHANNEL_ERROR("11003", "No permission to delete the channel!"),
	/**没有该栏目查看权限*/
	NO_PERMISSION_VIEW_CHANNEL_ERROR("11004", "No permission to view the channel!"),
	/**没有该栏目静态化权限*/
	NO_PERMISSION_STATIC_CHANNEL_ERROR("11005", "No permission to static the channel!"),
	/**没有该栏目创建子栏目权限*/
	NO_PERMISSION_CREATE_CHANNEL_ERROR("11006", "No permission to create the channel!"),
	/**没有该栏目分配权限*/
	NO_PERMISSION_PERM_ASSIGN_CHANNEL_ERROR("11007", "No permission to assign permission the channel!"),
	/**没有该栏目合并权限*/
	NO_PERMISSION_MERGE_CHANNEL_ERROR("11008", "No permission to merge the channel!"),
	/** 栏目不在站点下面*/
